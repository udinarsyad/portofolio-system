...
<body id="page-top">
    ...
    style="background-image: url({{ isset($getHeader) && $getHeader->image ? asset('storage/uploads/image/header/' . $getHeader->image) : asset('storage/uploads/image/header/WhatsApp Image 2024-06-05 at 13.53.48.jpeg') }})">
        <div class="overlay-itro"></div>
        <div class="intro-content display-table">
            <div class="table-cell">
                <div class="container">
                    <!--<p class="display-6 color-d">Hello, world!</p>-->
                    <h1 class="intro-title mb-4">{{ $getHeader->up_text ?? 'I AM Muhammad Arsyad Nizhamudin' }}</h1>
                    <p class="intro-subtitle"><span
                            class="text-slider-items">{{ $getHeader->down_text ?? 'Iam Student,Programmer' }}</span><strong
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-5">
                                            <div class="about-img">
                                                <img src="/1592300001150.jpg" alt="">
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-7">
                                            <div class="about-info">
                                                <p><span class="title-s">Name: </span>
                                                    <span>{{ $getAbout->name ?? 'Muhammad Arsyad Nizhamudin' }}</span></p>
                                                <p><span class="title-s">Profile: </span>
                                                    <span>{{ $getAbout->role ?? 'Student' }}</span></p>
                                                <p><span class="title-s">Email: </span>
                                                    <span>{{ $getAbout->email ?? 'arsyadnizham04@gmail.com' }}</span></p>
                                                <p><span class="title-s">Phone: </span>
                                                    <span>{{ $getAbout->phone ?? '088200958278' }}</span></p>
                                            </div>
                                        </div>
                                    </div>
                                    @if ($getSkill->count() > 0)
                ...
                <div class="container">
                    ...
                    <div class="row">
                        @foreach ($getPortfolio as $portfolio)
                            <div class="col-md-4">
                                <div class="work-box">
                                    <a href="{{ asset('storage/public/uploads/image/portfolio/' . $portfolio->image) }}"
